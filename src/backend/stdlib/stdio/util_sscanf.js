...
define(function() {
return function sscanf(str, format) {
  ...
  var _setExtraConversionSpecs = function (offset, j) {
  ...
  for (var i = 0, j = 0; i < format.length; i++) {
    ...
    if (format.charAt(i) === '%') {
      if (format.charAt(i + 1) === '%') {
        ...
        return _setExtraConversionSpecs(i + 2, j);
      }
      ...
      if ((_NWS)
        ...
        return _setExtraConversionSpecs(i + 1, j);
      } else {
